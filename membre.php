                            ...
                            <div class="accordion-item">
                                ...
                                <?php
                                    ...
                                    while ($row = mysqli_fetch_array($convos)) {
                                        ...
                                        <button onclick="montrerMessage();" type="button" class="btn btn-secondary btn-lg btn-block"><?php echo $row['firstName2']; ?></button>

                                    
                                        <?php
                                        } else {
                                        ?>
                                        <button onclick="montrerMessage();" type="button" class="btn btn-secondary btn-lg btn-block"><?php echo $row['firstName1']; ?></button>
